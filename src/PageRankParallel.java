...
public class PageRankParallel {
    ...
    public PageRankParallel(int numVertices, int numEdges, double dampingFactor, int maxIterations, long seed) {
    ...
    public void computePageRank() {
        ...
        System.out.println("Running parallel PageRank on " + availableProcessors + " processors");
    ...
    public static void main(String[] args) {
        if (args.length < 4) {
            System.out.println("Usage: java PageRankParallel <vertices> <edges> <damping_factor> <max_iterations> [seed]");
            System.out.println("Example: java PageRankParallel 1000 5000 0.85 100 42");
            return;
        }
        ...
        try {
            ...
            System.out.println("=== Parallel PageRank Configuration ===");
            ...
            PageRankParallel pageRank = new PageRankParallel(numVertices, numEdges, dampingFactor, maxIterations, seed);

            // Run computation
            pageRank.computePageRank();

            // Save results
            pageRank.saveGraphToCSV("graph_parallel.csv");
            pageRank.savePageRanksToCSV("pageranks_parallel.csv");
